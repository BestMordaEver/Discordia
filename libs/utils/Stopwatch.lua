...
---@field protected __init fun(self : Stopwatch, stopped? : boolean)
---@field protected __tostring fun(self : Stopwatch) : string
...
--[=[Defines the behavior of the `tostring` function. Returns a string that
represents the elapsed milliseconds for convenience of introspection.]=]
